...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <link rel="stylesheet" href="/styles.css?v=20260727-extension-1" />
      <div dangerouslySetInnerHTML={{ __html: bodyHtml }} />
      <ContactLanyardOverlay />
      <InspirationCloudOverlay />
      <Script src="/common.js?v=20260727-extension-1" strategy="afterInteractive" />
      <Script src="/script.js?v=20260727-extension-1" strategy="afterInteractive" />
    </>
  );
}
